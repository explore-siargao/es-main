...
* **api:** Added endpoint for get wishlist by category ([52b1307](https://github.com/explore-siargao/es-main/commit/52b1307ed20d2cf5c837aec952ee56af74515b9d))
* **api:** Added endpoint for get wishlist by category ([6a6b9c4](https://github.com/explore-siargao/es-main/commit/6a6b9c4fd657707631ba41054f43da1ed35b9344))
* **api:** Added endpoint for get wishlist by category ([255de0d](https://github.com/explore-siargao/es-main/commit/255de0d4cf8bd8c38b1cd5af0632ed94a3343fd8))
...
* before creating a listing host need to agree in the tc ([8814974](https://github.com/explore-siargao/es-main/commit/88149743e01307fb8c2a3bbd95aaa7bf234c7f9a))
...
* cart select all button is always selected ([1fab3dd](https://github.com/explore-siargao/es-main/commit/1fab3dd0f378afe1a6b7ea6de0a62e5d986a87d7))
* cart select all button is always selected ([a50146e](https://github.com/explore-siargao/es-main/commit/a50146e354cfa71e2df814191b29609a2a7d1c39))
...
* create booking list ui separate active finish and cancelled booking ([334fee8](https://github.com/explore-siargao/es-main/commit/334fee89dda013c7fa9dca8a5871be47e6a44ea4))
* create booking list ui separate active finish and cancelled booking ([eafbfd8](https://github.com/explore-siargao/es-main/commit/eafbfd8d1e3a0685bf53eb101efc2a236264ad1f))


### 🛠 Bug Fixes

* **api:** Filter/search properties ([46cf5e0](https://github.com/explore-siargao/es-main/commit/46cf5e09249bf95314d23687357131bad1ae32a6))
* **api:** Filter/search properties ([fb89700](https://github.com/explore-siargao/es-main/commit/fb89700c9fc4e55f0afd6935dec89b9576425670))
...
* **api:** Fixed activities filtering endpoint and adjusted the pricePerPerson types ([ae706fc](https://github.com/explore-siargao/es-main/commit/ae706fcab3bc6100519f6e0074ba5b806a67d686))

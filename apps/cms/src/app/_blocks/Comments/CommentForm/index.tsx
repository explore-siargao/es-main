...
export const CommentForm: React.FC<{
  ...
  const onSubmit = useCallback(
    async (data: FormData) => {
      ...
      try {
        const res = await fetch(`${process.env.PAYLOAD_NEXT_PUBLIC_SERVER_URL}/api/comments`, {
          method: 'POST',
          headers: {
        ...
        setSuccess(
          <Fragment>
            ...
            <Link
              href={`${process.env.PAYLOAD_NEXT_PUBLIC_SERVER_URL}/admin/collections/comments/${

            ...
            {bookableUnits.map((unit:T_BookableUnitType) => (
              ...
              >
                ...
                <div className="flex text-md mb-2 font-bold">{unit.category}</div>
                  ...
                  {unit.bed ?
                  <div className="flex text-md mb-2"> {unit.bed}</div> : null}
                  {unit.category === "Bed" ? 
                  <div className="flex text-md mb-2">{unit.description}</div> : null}
                  {unit.totalSize ? 
                  <div className="flex text-md mb-2">{unit.totalSize} Square meters</div> : null}
                  <div className="flex text-md mb-2">{unit.maxGuests} Guests capacity</div>
                  <Button
                    variant="link"
                    size="link"

...
function getRelativeDifference(inputDateString: string, currentDateString: string = new Date().toISOString()): string {
...
const HostedBy = ({ name, language, profilePicture, joinDate }: { name: string, language: string, profilePicture: string, joinDate: string }) => {
  return (
    <div className="flex gap-3 items-center justify-between">
      <div>
        <Typography variant="h4">Hosted by <span className="font-semibold">{name}</span></Typography>
        <Typography
          variant="h5"

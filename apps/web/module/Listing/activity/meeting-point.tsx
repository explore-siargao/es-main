    ...
    <div className="flex flex-col w-full">
      <div className="flex-1 w-full">
        ...
        <div className="mt-3">
          <DynamicMapWithPin
            center={
              [meetingPoint?.latitude, meetingPoint?.longitude] as [
                number,
                number,
              ]
            }
        ...
        <div className="text-md font-semibold mt-3">
          {meetingPoint?.streetAddress}, {meetingPoint?.barangay},{" "}
          {meetingPoint?.city}, Surigao del Norte
        </div>

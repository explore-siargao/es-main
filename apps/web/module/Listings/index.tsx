...
const sampleData = [
  {
    ...
    "description": "A luxurious villa located near the famous Cloud 9 surfing spot in Siargao.",
    "currency": "PHP",
    ...
    "location": {
      ...
      "longitude": 126.1842,
      "latitude": 9.8482,
      "howToGetThere": "From Sayak Airport, take a tricycle or van to Cloud 9, General Luna."
    },
  ...
  },
  {
    ...
    "description": "A vibrant hostel perfect for surfers and adventurers in the heart of General Luna.",
    "currency": "PHP",
    ...
    "location": {
      ...
      "longitude": 126.1571,
      "latitude": 9.8462,
      "howToGetThere": "Take a van or habal-habal from Sayak Airport to Poblacion, General Luna."
    },
  ...
  },
  {
    ...
    "description": "An eco-conscious stay amidst the coconut trees, perfect for nature lovers.",
    "currency": "PHP",
    "primaryLanguage": "English",
    "price": 1499,
    "photos": [
    ...
    "location": {
      ...
      "longitude": 126.2150,
      "latitude": 9.8660,
      "howToGetThere": "From General Luna, drive 30 minutes north to San Roque, Pilar."
    },
  ...
  },
  {
    ...
    "description": "A stylish boutique hotel offering comfort and convenience near the famous Cloud 9.",
    "currency": "USD",
    "primaryLanguage": "English",
    "price": 1599,
    "photos": [
  ...
  },
  {
    ...
    "description": "A premium resort offering exclusive amenities with stunning ocean views in Dapa, Siargao.",
    "currency": "USD",
    "primaryLanguage": "English",
    "price": 1699,
    "photos": [
    ...
    "location": {
      ...
      "longitude": 126.1124,
      "latitude": 9.7615,
      "howToGetThere": "Take a ferry from Surigao City to Dapa. The resort is 10 minutes from the port."
    },
  ...
  },
  {
    ...
    "description": "A cozy homestay near the mangrove forest in Del Carmen, offering an authentic Siargao experience.",
    "currency": "PHP",
    "primaryLanguage": "Filipino",
    "price": 1799,
    "photos": [
    ...
    "location": {
      ...
      "longitude": 126.0702,
      "latitude": 9.8813,
      "howToGetThere": "A 30-minute drive from Sayak Airport. The homestay is near the mangrove boardwalk."
    },
  ...
  },
  {
    ...
    "description": "A stylish bungalow near the peaceful shores of Pacifico, perfect for relaxation and surfing.",
    "currency": "PHP",
    "primaryLanguage": "English",
    "price": 1899,
    "photos": [
    ...
    "location": {
      ...
      "longitude": 126.2238,
      "latitude": 9.9812,
      "howToGetThere": "45 minutes north of General Luna, near the Pacifico surf break."
    },
  ...
  },
  {
    ...
    "description": "A peaceful cottage along the river in San Benito, offering a rustic getaway in nature.",
    "currency": "PHP",
    "primaryLanguage": "Filipino",
    "price": 1999,
    "photos": [
    ...
    "location": {
      ...
      "longitude": 126.0823,
      "latitude": 9.9271,
      "howToGetThere": "A 25-minute drive from Del Carmen, following the road along the river."
    },

...
import useUpdatePropertyPhotos from "../../hooks/useUpdatePropertyPhoto"
import useGetPropertyById from "../../hooks/useGetPropertyById"
import useAddPropertyPhotos from "../../hooks/useAddPropertyPhotos"
import useDeletePropertyPhoto from "../../hooks/useDeletePropertyPhoto"
import useUpdatePropertyFinishedSections from "../../hooks/useUpdatePropertyFinishedSections"
...
const ListingPhotos = ({ pageType }: Prop) => {
  ...
  const { mutateAsync, isPending } = useUpdatePropertyPhotos(listingId)
  const { mutateAsync: addMutateAsync } = useAddPropertyPhotos(listingId)
  const { mutateAsync: deleteMutateAsync } = useDeletePropertyPhoto(listingId)
  const { mutateAsync: updateFinishedSections } =
    useUpdatePropertyFinishedSections(listingId)

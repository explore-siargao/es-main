...
import { T_Calendar_Private_Activity, T_Calendar_Reservation } from "@repo/contract"
...
type T_Calendar_Store = {
  ...
  activityData: T_Calendar_Private_Activity[]
  ...
  setActivityData: (value: T_Calendar_Private_Activity[]) => void

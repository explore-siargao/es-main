...
import { T_BackendResponse, T_Calendar_Reservation, T_Joiner_Activity } from "@repo/contract"
                    ...
                    return (
                      <div
                        ...
                        onClick={() => {
                          ...
                          // setSelectedReservation({ ...reservation, activityName: activity.name, slotName: slot.name })
                        }}

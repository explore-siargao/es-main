...
const PropertyCalendarTable = () => {
  ...
  const noReservationCount = category?.bookableUnitTypes?.reduce((count: number, bookableUnitType: { reservations: any[] }) => {
    const hasReservation = bookableUnitType.reservations.some(reservation => {

...
const HostingTodayArriving: React.FC<HostingPageProps> = () => {
  const allTabsIsZero = TABS.every((tab) => tab.value === 0)
  let icon = null
  let description = null
  if (allTabsIsZero) {
    icon = <LucideBook />
    description = "You don't have any guests arriving today or tomorrow"
  }
  return (
    <div className="mt-20">
      <div>
...
export default HostingTodayArriving

...
export default async function HostNewListingRentalLayout({
  children,
}: {
    ...
    <html lang="en">
      ...
      <body>
        ...
        <QueryClientWrapper>
          <AuthStateProvider>
            <GlobalModalWrapper>
              <ListingHeader listingStatus={E_Listing_Status.setup} category={E_Listing_Category.Rental} />
              <ListingSidebar status="setup" category={E_Listing_Category.Rental}>{children}</ListingSidebar>
            </GlobalModalWrapper>
          </AuthStateProvider>
        </QueryClientWrapper>
      </body>

...
import Header from "@/common/components/AdminLayout/NewListingRentalHeader"
import Sidebar from "@/common/components/AdminLayout/NewListingRentalSidebar"
...
export default async function HostNewListingLayout({
  children,
}: {

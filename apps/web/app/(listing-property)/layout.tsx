    ...
    <html lang="en">
      ...
      <body>
        ...
        <QueryClientWrapper>
          <AuthStateProvider>
            <GlobalModalWrapper>
              <ListingHeader listingStatus={E_Listing_Status.edit} category={E_Listing_Category.Property} />
              <ListingSidebar category={E_Listing_Category.Property}>{children}</ListingSidebar>
            </GlobalModalWrapper>
          </AuthStateProvider>
        </QueryClientWrapper>
      </body>

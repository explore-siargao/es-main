...
const CategoryButtonsByState = ({ category: currCategory, setCategory, light = false }: {category: E_Listing_Category,  setCategory: Dispatch<E_Listing_Category>, light?: boolean}) => {
  return (
    <>
